...
namespace IPZ {
	...
	/// <summary>
	/// Summary for Help_myform
	/// </summary>
	public ref class Help_myform : public System::Windows::Forms::Form
	{
	public:
		Help_myform(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Help_myform::typeid));
			...
			this->button1->Location = System::Drawing::Point(100, 361);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(152, 48);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Zamknij";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Help_myform::button1_Click);
			// 
			// label1
			// 
			...
			this->label1->Size = System::Drawing::Size(319, 60);
			this->label1->TabIndex = 2;
			this->label1->Text = L"Wykonali:\r\nDawid Kurpiel Filip Ruchel";
			...
			this->ClientSize = System::Drawing::Size(351, 451);
